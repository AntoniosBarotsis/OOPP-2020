...
class OthersQuestionControllerTest {
    ...
    void loadData() {
        ...
        4. Join that room in the other windows as different students.
        5. Ask a question as one of the students.
        6. Check that everything is translated correctly and looks good in the moderator view.
         */
    }
}